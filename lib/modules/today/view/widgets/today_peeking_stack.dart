...
const double kTodayPeekStep = 28;

/// Total height of the peeking stack viewport.
const double kTodayStackHeight = 176;
...
class TodayPeekingStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (count == 0) return const SizedBox(height: kTodayStackHeight);

    return SizedBox(
      height: kTodayStackHeight,
      child: AnimatedBuilder(
        ...
        builder: (context, _) {
          ...
          for (int i = count - 1; i >= 0; i--) {
            ...
            final riseFrom = i * kTodayPeekStep + 26.0;
